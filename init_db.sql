...
CREATE TABLE device(ref CHAR(5) PRIMARY KEY, idCategory INTEGER, name VARCHAR(30), version VARCHAR(15), photo VARCHAR, phone VARCHAR(12), lockDays VARCHAR(255),
...
INSERT INTO device VALUES("AN001", 1, "Samsung Galaxy S1000", "1.0", "", "0123456789", null);
INSERT INTO device VALUES("AN002", 1, "Huawei P80", "1.1", "", "1234567890", null);
