...
CREATE TABLE category(id INTEGER PRIMARY KEY , name INTEGER);
CREATE TABLE device(ref CHAR(5) PRIMARY KEY, idCategory INTEGER, name VARCHAR(30), version VARCHAR(15), photo VARCHAR, phone INTEGER(10),
