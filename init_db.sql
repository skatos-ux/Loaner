...
CREATE TABLE device(ref CHAR(5), idCategory INTEGER, name VARCHAR(30), version VARCHAR(15), photo VARCHAR, phone VARCHAR(10));
...
CREATE TABLE category(id INTEGER, name VARCHAR(255));
